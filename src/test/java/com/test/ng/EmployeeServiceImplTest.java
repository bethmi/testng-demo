...
import com.test.ng.model.Employee.WorkShift;
import com.test.ng.service.impl.EmployeeServiceImpl;
...
public class EmployeeServiceImplTest {
    ...
    public void testGenerateBasicSalarySuccess() {
        Employee employee = new Employee(114, "Steve", "Hale", WorkShift.DAY, 6);
        try {
    ...
    public void testGenerateBasicSalaryFailure() {
        Employee employee = new Employee(114, "Steve", "Hale", WorkShift.DAY, 0);
        try {
            employeeService.generateBasicSalary(employee);
    ...
    @Test(groups = {"failure-test"}, expectedExceptions = Exception.class, expectedExceptionsMessageRegExp = "Employee working details canno")
    ...
    @Test(groups = {"basic"})
    public void verifyGrossSalaryCalculation(double additions, double deductions) {
        try {
            Employee employee = new Employee(112, "John", "Doe", WorkShift.DAY, 8);
    ...
    public Object[][] createEmployeeData() {
        Employee employee1 = new Employee(112, "John", "Doe", WorkShift.DAY, 8);
        Employee employee2 = new Employee(113, "Jason", "Doe", WorkShift.DAY, 3);
        Employee employee3 = new Employee(114, "Mark", "Dave", WorkShift.DAY, 5);
        return new Object[][]{
                {employee1, 1000, 2000},
                {employee2, 1000, 2000},
                {employee3, 1000, 2000}
